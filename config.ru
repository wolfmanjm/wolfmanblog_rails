...
if ENV['RACK_ENV'] == "production"
  ...
  begin
    ...
    if r.ping == 'PONG'
      ...
      use Rack::Spammers, :cache => r, :urlmap => [ [:get, %r{\+\+GET\+http}], [:post, %r{/articles/\d+/\d+/\d+/.*comments/\d+}], [:get, %r{/scripts/setup.php}], [:get, %r{w00tw00t}] ], :log => ::File.expand_path('../log/spammers.log',  __FILE__)
